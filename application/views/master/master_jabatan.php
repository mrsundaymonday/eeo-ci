    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="defaultModalLabel">Master Jabatan</h4>
            </div>
...
function edit_data(id) {
    ...
    $.ajax({
        url: "<?php echo site_url('jabatan/getjabatan_byid/')?>" + id,
        type: "GET",
        dataType: "JSON",
        beforeSend: function() {
            Swal.fire({
        ...
        success: function(data) {
            ...
            $('#modal').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Update jabatan'); // Set title to Bootstrap modal title
...
function save() {
    ...
    if (save_method == 'add') {
        ...
        url = "<?php echo site_url('jabatan/jabatan_update')?>/" + $('input[name="id"]').val();
    }
    Swal.fire({
        title: 'Are you sure?',
...
function delete_data(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo site_url('jabatan/jabatan_delete/') ;?>" + id,
                type: "POST",
                dataType: "JSON",
                beforeSend: function() {
                    Swal.fire({
